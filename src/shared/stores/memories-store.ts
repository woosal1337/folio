...
export const useMemoriesStore = create<MemoriesState>((set, get) => ({
  ...
  create: async (newMemory) => {
    try {
      ...
      toast.error("Could not create memory", { description: humanizeError(e) });
      return null;
    }
  },
  ...
  update: async (id, patch) => {
    try {
      ...
      toast.error("Could not update memory", { description: humanizeError(e) });
      return null;
    }
  },
  ...
  pin: async (id, pinned) => {
    try {
      ...
      toast.error("Could not pin memory", { description: humanizeError(e) });
      return null;
    }
  },
  ...
  remove: async (id) => {
    ...
    try {
      ...
      toast.error("Could not archive memory", { description: humanizeError(e) });
      set({ memories: prev });
    }
  },
  ...
  purge: async (id) => {
    ...
    try {
      ...
      toast.error("Could not purge memory", { description: humanizeError(e) });
      set({ memories: prev });
    }
  },
  ...
  rebuildIndex: async () => {
    try {
      ...
      toast.error("Could not rebuild memory index", { description: humanizeError(e) });
      return null;
    }
  },
}));
