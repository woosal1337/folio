    ...
    <div className="mx-auto flex w-full max-w-xl flex-col gap-7 px-6 py-12">
      <header data-drag="" className="select-none">
        ...
        <p className="mt-2 max-w-prose text-sm text-muted-foreground">
          Attune uses macOS Calendar to find the meeting you&apos;re in and name your
      ...
      <ul className="space-y-3.5 rounded-lg border border-border bg-card p-5">
        ...
        <Bullet
          ...
          body="Attune calls Apple's EventKit API on this Mac. Event data is never uploaded; we don't ask for write access."
        />
        <Bullet
          icon={Check}
