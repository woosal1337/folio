...
const SLOTS: SlotConfig[] = [
  {
    slot: "microphone",
    title: "My microphone",
    description: "Capture what you say so Attune can transcribe it.",
    icon: Mic,
  },
  {
    ...
    <div className="mx-auto flex w-full max-w-2xl flex-col gap-7 px-8 py-12">
      <header className="select-none" data-drag="">
        ...
        <h1 className="mt-3 font-serif text-3xl font-medium tracking-tight">
          Allow Attune to transcribe your meetings
        </h1>
        <p className="mt-3 max-w-prose text-sm text-muted-foreground">
          Attune captures your meeting audio locally. No bots. No upload.
        </p>
      </header>
