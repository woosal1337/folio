...
export function SectionWebhooks() {
  ...
  const refresh = React.useCallback(async () => {
    ...
    try {
      ...
      toast.error("Could not load webhooks", { description: String(e) });
    } finally {
      setLoading(false);
    }
  }, []);
  ...
  const startNew = () => {
    setDraft({
      id: "",
      label: "",
      url: "http://localhost:9000/attune",
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      toast.error("Could not save webhook", { description: String(e) });
    }
  };
  ...
  const handleDelete = async (id: string) => {
    ...
    try {
      ...
      toast.error("Could not delete webhook", { description: String(e) });
    }
  };
  ...
  const handleTest = async (id: string) => {
    ...
    try {
      ...
      toast.error("Webhook test failed", { description: String(e) });
    } finally {
      setTesting(null);
    }
  };
  ...
  const toggleEnabled = async (sub: WebhookSubscription) => {
    ...
    try {
      ...
      toast.error("Could not update webhook", { description: String(e) });
    }
  };
        ...
        <div className="flex flex-col gap-3 rounded-lg border border-border bg-card p-4">
          ...
          <Label className="text-xs">
            ...
            <Input
              ...
              placeholder="http://localhost:9000/attune"
