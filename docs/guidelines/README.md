...
- **New patterns get a section.** When you discover a new "Attune-specific refactor candidate" or pitfall, add it to the matching doc under the existing "Attune-specific recommendations" section.
...
- **Codebase-specific architecture** — that lives in [`docs/ARCHITECTURE.md`](../ARCHITECTURE.md) and the Obsidian vault at `~/Documents/GitHub/obsidian.md/projects/attune/`.
