...
These documents are the *reference library*. The repo's enforced, opinionated
...
exists to (a) explain the *why* behind those rules with citations, and (b) cover
...
> target the **Rust** code (`crates/attune-core`, `crates/attune-cli`,
