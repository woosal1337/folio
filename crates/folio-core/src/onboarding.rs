...
pub fn bundle() -> DemoBundle {
    ...
    DemoBundle {
        ...
        segments: vec![
            seg(0.0, 4.5, "mic", "You", "Welcome to Folio. This is a demo meeting that lasts about ninety seconds."),
...
pub fn materialise(recordings_root: &Path) -> Result<PathBuf> {
    ...
    let body = serde_json::to_string_pretty(&bundle)
        .map_err(|e| FolioError::Storage(format!("could not serialise demo bundle: {e}")))?;
